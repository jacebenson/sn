---
title: "UserSetSubscriptionSyncHelper"
id: "usersetsubscriptionsynchelper"
---

API Name: global.UserSetSubscriptionSyncHelper
...
UserSetSubscriptionSyncHelper.prototype = {
	...
	startSync: function() {
		var autoSyncedLicenseGR = this._getAllUserBasedLicense();
	...
	_getAllUserBasedLicense: function() {
		var licenseDetailsGR = new GlideRecord(this.LICENSE_DETAILS_TABLE);
		licenseDetailsGR.addQuery('license_type', 0);
		licenseDetailsGR.addQuery('display_only', false);
		licenseDetailsGR.query();

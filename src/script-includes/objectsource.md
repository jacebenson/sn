...
initialize: function(source_name, table, table_id, source) {
	...
	if (source){
		...
		this.id = 'Discovery'; 
		// PRB642152: the warning message was removed since there are many places that discovery was run without passing the source and 
		// they don't care about the source, so this message doesn't give them any helpful information. 

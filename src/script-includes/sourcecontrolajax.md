---
title: "SourceControlAjax"
id: "sourcecontrolajax"
---

API Name: global.SourceControlAjax
...
SourceControlAjax.prototype = Object.extendsObject(AbstractAjaxProcessor, {
	...
	start: function() {
		...
		var mid_server_id = this.getParameter('sysparm_ajax_processor_mid_server_id');
		var credentialId = this.getParameter('sysparm_ajax_processor_credential_id');
		...
		gs.log("SourceControlAjax: midserver = " + mid_server_id);

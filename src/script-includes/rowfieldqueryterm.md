---
title: "RowFieldQueryTerm"
id: "rowfieldqueryterm"
---

API Name: global.RowFieldQueryTerm
...
RowFieldQueryTerm.prototype = {
    ...
    getQueryTerm : function() {
		...
		if (ed.isDateType() && (fieldValue == null ||
			(!(ed.isEdgeEncrypted() && fieldValue.startsWith('\uFDD0\uFDD1')) &&
			!(ed.isEncrypted() && fieldValue.startsWith('\uFDE0\uFDE1')))))

---
title: "AbstractSchedulePageRESTWrapper"
id: "abstractschedulepagerestwrapper"
---

API Name: sn_schedule_pages.AbstractSchedulePageRESTWrapper
		...
		if (!checkReadAccess || (checkReadAccess && gr.canRead())) {
			...
			for (var i = 0; i < elements.length; i++) {
				...
				if (fieldReadAccess) {
					...
					} else if (gr[fieldName].getED().getInternalType() == this.FIELD_TYPE_STRING) {
						obj[fieldName].display_value = GlideStringUtil.escapeHTML(gr.getDisplayValue(fieldName));
					} else

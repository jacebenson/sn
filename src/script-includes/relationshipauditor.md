---
title: "RelationshipAuditor"
id: "relationshipauditor"
---

API Name: global.RelationshipAuditor
...
RelationshipAuditor.prototype = {
  ...
  _setup : function(gr, action) {  
    ...
    if (gr.instanceOf('cmdb_rel_ci')) {            
      if (gr.parent.nil() || gr.child.nil() || !tgr.get('sys_id', gr.parent) || !tgr2.get('sys_id', gr.child))
         return false;

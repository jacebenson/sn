---
title: "TranslationUtils"
id: "translationutils"
---

API Name: global.TranslationUtils
...
TranslationUtils.prototype =  {
	...
	_convertTranslations: function() {
		...
		while (targetTbl.next()) {
			for (col in this._cvtCols) {
				if (!this._cvtCols[col])
					continue;

				if (Object.keys(transMatrix).length > 0 && typeof transMatrix[col][targetTbl[col]+""] !== "undefined") {

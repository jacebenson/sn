---
title: "PwdVerifySMSProcessor"
id: "pwdverifysmsprocessor"
---

API Name: global.PwdVerifySMSProcessor
...
PwdVerifySMSProcessor.prototype = {
	...
	**********/
    ...
    verify: function(reset_request_id, enrolled_user_id, verification_id, request) {
		...
		if (mode == 'subscription' || 'mobile')
		    ret = smsMgr.verifyResetCode(reset_request_id, verification_id, answer);
		else 

...
LDAPUtils.prototype = {
    ...
    checkGroupForServer: function(ldapConfig, groupOU) {
       ...
       if (result == null || !result.hasMore()) {
          if (GlideStringUtil.nil(ldapTarget.getRDN())) {
             gs.addErrorMessage("WARNING: RDN value is missing for Server: " + ldapConfig.getName() + ", OU: " + ldapTarget.getName());
          }
          return false;
       }

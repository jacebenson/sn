---
title: "DiscoveryLogger"
id: "discoverylogger"
---

API Name: global.DiscoveryLogger
...
DiscoveryLogger.DEBUG = '-1';  // put this in quotes to force string value treatment, otherwise 'Debug' would not be matched
...
DiscoveryLogger.debug = function(msg, source, sensor, ci, resultCode) {
	var dl = new DiscoveryLogger();
	dl.debug(msg, source, sensor, ci, resultCode);
};
...
DiscoveryLogger.prototype = {
	...
	debug: function(msg, source, sensor, ci, resultCode) {
		this.log(DiscoveryLogger.DEBUG, msg, source, sensor, ci, resultCode);
	},

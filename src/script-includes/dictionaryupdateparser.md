---
title: "DictionaryUpdateParser"
id: "dictionaryupdateparser"
---

API Name: global.DictionaryUpdateParser
	...
	loadFromUpdates:function (setIds) {
		...
		while (update.next()) {
			...
			if (type == "Dictionary") {
				...
				if(null == tableName || null == columnName) //PRB665621
					continue;

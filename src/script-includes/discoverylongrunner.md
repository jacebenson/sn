---
title: "DiscoveryLongRunner"
id: "discoverylongrunner"
---

API Name: global.DiscoveryLongRunner
...
DiscoveryLongRunner.prototype = {
  ...
  pollProbe: function(cancel) {
     ...
     if (cancel) {
         ...
         probe.copy(g_probe);
         // createForMidServer so it cancels on same mid server that is running the repeating probe
         probe.createForMidServer(g_probe.getAgent(), g_probe.getEccQueueId());
     } else {
         probe.setCorrelator(g_probe.getCorrelator());

---
title: "TableAugmentationFinder"
id: "tableaugmentationfinder"
---

API Name: sn_appauthor.TableAugmentationFinder
...
TableAugmentationFinder.prototype = {
	...
	//necessary to eliminate artifacts from TPP dictionary clones
	col.addNotNullQuery("sys_update_name");
        col.query();
        while (col.next()) {
            columnInfo = {

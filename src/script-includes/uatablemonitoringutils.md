---
title: "UATableMonitoringUtils"
id: "uatablemonitoringutils"
---

API Name: global.UATableMonitoringUtils
...
UATableMonitoringUtils.prototype = {
	...
	addMonitorforTable : function(/*string*/table_name, /*string*/query, /*boolean*/in_report, /*string*/descrip) {
		...
		gr.definition_id = PUB_PREFIX + GlideGuid.generateRand();
		gr.exec_time_threshold = '100';
		gr.name = table_name;
		gr.active = true;
